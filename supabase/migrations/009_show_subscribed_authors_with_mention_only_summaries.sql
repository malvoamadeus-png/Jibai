-- Author feeds should show subscribed authors that have crawled content even
-- when the analyzer only produced mention_only viewpoints. Stock/theme entity
-- pages still filter mention_only viewpoints in their own RPCs.
