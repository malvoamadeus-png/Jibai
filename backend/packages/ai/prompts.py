    ...
    return [
        {
            ...
            "content": (
                ...
                "events 用于承载非作者观点的客观信息，例如新闻、事件、独家报道、公告、管理层表述、分析师预期、产能/订单/产品/政策/供应链更新、业绩事实、非行情类数据播报。"
                "events 必须是近期具体发生或被披露的事情，至少应对应一个新闻、公告、报道、通知、发布、调价、供给变化、业绩/指引更新、订单/产能/政策变化或新数据更新。"
                "不要把历史研究报告分享、历史规律回顾、长期趋势资料、行业知识科普、技术概念解释、工业流程定义、产品/工艺关系辨析输出为 event；这类即使客观，也不是新闻事件。"
                ...
                "event_type 可使用 earnings_update, guidance_update, management_commentary, product_update, policy_update, supply_chain_update, supply_risk, profitability_outlook, analyst_report, exclusive_report, data_point, rumor, other。"
                "supply_risk 专门用于短缺、断供、供应无法保障、关键原材料/半导体材料涨价、供应商产能受限或建议客户多元采购等供应风险。"
                "不要把股票、指数、ETF 或市场价格上涨/下跌/盘前盘后涨跌/创高创低等行情涨跌播报输出为 event；这类不算新闻。"
                "材料、零部件或服务本身的涨价属于供应风险，可以输出为 supply_risk，不要误判为行情涨跌播报。"
