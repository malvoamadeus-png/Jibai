...
def diagnose_worker_once() -> int:
    ...
    print(
        ...
        f"stock_blogger_score={'enabled' if _stock_blogger_score_enabled() else 'disabled'} "
...
def run_worker(*, once: bool = False) -> int:
    ...
    scheduler.add_job(
        ...
        CronTrigger(hour=int(crypto_brief_hour), minute=int(crypto_brief_minute), timezone=SHANGHAI_TZ),
        id="public-crypto-asset-brief",
        replace_existing=True,
    )
    print(
